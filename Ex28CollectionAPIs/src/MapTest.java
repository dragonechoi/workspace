...
public class MapTest {
	...
	public static void main(String[] args) {
		...
		// Map 인터페이스를 구현한 하위 클래스들 : HashMap, TreeMap, LinkedHashMap, HashTable[HashMap과 동일- 동기화처리가 되어 있음]
		
		//<key,value>
		//HashMap<String, String> map= new HashMap<String, String>(); // 가장 성능 우수함.
		//TreeMap<String, String> map= new TreeMap<String, String>(); // 키값을 오름차순으로 저장 [성능 중간]
		...
		//방법3. 우선 키값들만 Set객체로 우선 얻어와서 반복문으로 처리
		...
		// 키값을 그냥 정수숫자로 할 수도 있음.
		HashMap<Integer, String> map2= new HashMap<>();
		map2.put(1, "aaa");
		map2.put(2, "bbb");
		map2.put(3, "ccc");
		
		// 사용자정의 클래스를 value로 사용할 수도 있음.
		HashMap<String, Person> map3= new HashMap<>();
		map3.put("사장", new Person("sam", 50));
		map3.put("부장", new Person("robin", 40));
		map3.put("차장", new Person("hong", 30));		
