...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		// 만약 2차원 배열이 가진 참조변수들이 모두 같은 개수의 배열객체를 참조한다면.. 쉽게 2차원배열객체를 생성할 수 있음.
		...
		//2차원배열의 길이값을 변수로 지정해보기.. 키보드로 입력받은 개수크기로..
		...
		//입력된 층수만큼 1차원배열 참조변수들에 객체 대입해주기
		...
		// 입력된 층수, 호실 수 만큼 배열이 잘 만드어 졌는지 확인..
		for( int[] t : eee ) {
			for( int e : t ) {
				System.out.print( e +" , ");
			}
		...
		// 3차원 배열도 .. 2차원배열 참조변수를 여러개 가진 배열객체
		int[][][] abc= new int[2][][]; //2차원배열 참조변수가 2개짜리 배열객체
		...
		// 실무환경에서는 대량의 데이터 개수가 유동적인 경우가 더 많음. [ex. 게시글. 트윗글. 상품목록들.. ]
