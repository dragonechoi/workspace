...
public class Main {
	...
	public static void main(String[] args) {
		...
		//객체를 생성(new)할때 결정하도록 하는 문법
		
		//데이터를 하나 저장할 수 있는 클래스 설계 [자료형을 미리 정하지 않고]
		//객체를 생성할때 <>제네릭문법으로 자료형을 지정해주는 기법
		...
		//Box<int> box3; //error : 기본형 자료형 int는 <>에 사용할 수 없음.
		
		//그럼에도 int형 같은 기본형을 사용하고 싶다면. Wrapper class를 대체사용함
